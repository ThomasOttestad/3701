...
queries = (
        ("SELECT c.customer_name FROM orders AS o JOIN product AS p ON(o.product_id = p.product_id) JOIN customer AS c ON(c.customer_id = o.customer_id) where o.product_id < 1000", 1000, 1),
        ...
        ("SELECT * from product WHERE product_id < 10000" ,10000, 4),
